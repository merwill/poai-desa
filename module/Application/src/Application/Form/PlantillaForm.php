...
class PlantillaForm extends Form
{
    ...
    public function __construct($formName, $options = array())
    {
        ...
        foreach ($objetosFormulario as $objetoForm) {
            ...
            switch ($objectType) {
                case 'text':
                    ...
                    if ($readonly) {
                        $objetoText->setAttribute('readonly', $readonly);
                    }
                ...
                case 'textarea':
                    ...
                    $objetoTextArea->setLabel($label)
                                  ...
                                  // ->setAttribute('required', $class)
                                   ...
                                   ->setAttribute('placeholder', $placeholder);
                     if ($readonly) {
                         $objetoTextArea->setAttribute('readonly', $readonly);
                     }
        ...
        /*$buttonClose = new Element\Button('cerrar');
        $buttonClose->setLabel('Close')
            ->setValue('close')
            ->setAttribute('class', "btn btn-default red")
            ->setAttribute('onclick', "closeModalBootstrap('miModal')");
